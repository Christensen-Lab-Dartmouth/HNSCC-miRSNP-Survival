###########################
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Get miRNAseq isoform specific expression data for miRNAs of interest from TCGA tumor tissue samples from HNSCC subjects 
...
setwd("TCGA_miRseq_analysis/Data_files/TCGA_HNSC_miRNA-seq_isoforms_primary_tumor/")
dir()
...
# index data for only these miRNAs
avg_rpm_2 <- avg_rpm[avg_rpm$MIMAT_2 %in% unique(mimats_of_int_2$MIMAT),] 

# write out averaged exprsssion data  
write.csv(avg_rpm_2, file = "TCGA_miRseq_analysis/Survival/Data_files/TCGA_HNSCC_miRNA_exp_tumor_tissue_isoforms_survival.csv")
